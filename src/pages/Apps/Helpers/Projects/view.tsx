...
const ColumnChooser = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Projects', link: '/projects/view', isActive: true },
    ];
    ...
    return (
        <div>
            ...
            <Breadcrumbs
                ...
                addButton={{ label: 'Add Project', link: '/projects/create' }}
            />

            <div className="panel mt-6">
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Show/H</h5>
