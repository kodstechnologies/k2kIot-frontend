...
interface BreadcrumbProps {
  ...
  addButton?: { label: string; link?: string }; // Add button properties
}
    ...
    <div className="panel flex justify-between items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
          ...
          return (
            ...
            >
              <a
                ...
                } relative flex items-center before:absolute ltr:before:-right-[15px] rtl:before:-left-[15px] rtl:before:rotate-180 before:inset-y-0 before:m-auto before:w-0 before:h-0 before:border-[16px] before:border-l-[15px] before:border-r-0 before:border-t-transparent before:border-b-transparent ${
                  item.isActive || isCurrentPage
      ...
      {addButton && (
        <div className="ml-auto">
          <Link
            to={addButton.link || '#'}
            className="btn bg-info text-white-light hover:bg-primary/80 px-4 py-2 rounded-md"
          >
            {addButton.label || 'Add'}
          </Link>
        </div>
